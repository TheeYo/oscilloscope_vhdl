...
TOP_LEVEL_NAME="video_clock_for_DE"
QSYS_SIMDIR="./../"
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/video_clock_for_DE_video_pll_0_video_pll.vo" -work video_pll         -cdslib ./cds_libs/video_pll.cds.lib        
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/video_clock_for_DE_video_pll_0.vhd"          -work video_pll_0       -cdslib ./cds_libs/video_pll_0.cds.lib      
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/video_clock_for_DE.vhd"                                                                                                     
fi
